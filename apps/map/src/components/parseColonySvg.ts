...
// defs) — the upload confirmation must match what the map itself shows, or the
// verification gate D-025 exists for is effectively blank (no fill for roads/gardens).
